...
module.exports.run = async (bot, message, args) => {
  ...
  if(!mutekisi) return message.reply(`<a:739589662120738836:739589662120738836> Lütfen bir kullanıcı etiketleyiniz! \nDoğru Kullanım; \`${prefix}mute <@kullanıcı> <1sn/1dk/1sa/1g>\``)
  if(mutekisi.hasPermission("MANAGE_MESSAGES")) return message.reply(`<a:739589662120738836:739589662120738836> Yetkili bir kişiyi muteleyemem! \nDoğru Kullanım; \`${prefix}mute <@kullanıcı> <1sn/1dk/1sa/1g>\``)
  ...
  if(!mutezaman) return message.reply(`<a:739589662120738836:739589662120738836> Lütfen bir zaman giriniz! \nDoğru Kullanım; \`${prefix}mute <@kullanıcı> <1sn/1dk/1sa/1g>\``)
