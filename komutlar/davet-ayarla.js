...
exports.run = async (client, message, args, config) => {
  ...
  let channel = message.mentions.channels.first()
    ...
    if (!channel) {
        return message.reply("*<a:737724884104511499:737724884104511499> Doğru Kullanım  t!davet-takip #kanal **")
    }
